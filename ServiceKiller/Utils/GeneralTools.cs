...
namespace ServiceKiller
{
    ...
    /// the .NET 1.0 days when the libraries weren't mature. I tend to
    /// carry this class around from project to project.
    /// </summary>
    internal sealed class GeneralTools
    {
        ...
        internal static void WriteAnythingToFile(string path, string filename, List<string> obj)
        {
            // these next two come in very handy for writing settings and crap out
            // to files without having to deal with .net's settings file garbage
            try
        ...
        internal static void ReadAnythingFromFile(string filename, ref List<string> obj)
        {
            // overload. If you need an array and have no clue how many elements
            // are in the text file
